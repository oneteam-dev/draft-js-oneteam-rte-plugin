  ...
  _createClass(MarkupGenerator, [{
    ...
    value: function renderBlockContent(block) {
      ...
      var ret = entityPieces.map(function (_ref) {
        ...
        var entity = entityKey ? _DraftEntity2.default.__get(entityKey) : null;
        var entityType = entity == null ? null : entity.getType();

        var content = void 0;
        if (_this.options.entityRenderers && _this.options.entityRenderers[entityType]) {
          content = _this.options.entityRenderers[entityType](entity, stylePieces);
        } else {
          content = stylePieces.map(function (_ref3) {
